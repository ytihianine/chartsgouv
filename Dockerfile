...
COPY --from=dsfr_image /app/superset-dsfr/docker/pythonpath_dev/superset_config.py /app/pythonpath/superset_config.py
COPY --from=dsfr_image /app/superset-dsfr/docker/pythonpath_dev/superset_config_docker.py /app/pythonpath/superset_config_docker.py
