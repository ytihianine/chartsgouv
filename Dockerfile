...
# COPY --from=dsfr_image /app/superset-dsfr/docker/pythonpath_dev/superset_config.py /app/pythonpath_dsfr/superset_config.py
COPY --from=dsfr_image /app/superset-dsfr/docker/pythonpath_dev/superset_config_docker.py /app/pythonpath_dsfr/superset_config_docker.py
ENV SUPERSET_CONFIG_PATH=/app/pythonpath_dsfr/superset_config_docker.py
